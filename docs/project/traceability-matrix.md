...
| PH9-CHK-002 | CP-003, PRT-002/008 | `ph9-chk-002-junction-feed-diagnosis.md` | (diagnosis) `nec_solver` junction continuity | (reproductions in doc) | **Diagnosed** 2026-07-04: junctions enforce current but not charge continuity → wrong at high-current centre junctions (split/bent dipole neg-R), OK at low-current loading junctions. Fix scoped (junction basis / charge continuity); deferred. | 🔬 |
