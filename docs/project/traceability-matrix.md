...
| PH8-CHK-004 | CP-003, PRT-002 | `ph8-chk-004-nt-network.md` | `nec_solver/network.rs` (`build_nt_stamps`, Y→Z) | `nec_solver/tests/nt_network.rs` (TL-equivalence, singular-Y, missing-endpoint) | **Stamp core** 2026-07-02: NT admittance→Z stamp, validated identical to the TL stamp (\|Δ\|<1e-9); 550 tests. CLI wiring + real fixture pending. | 🔨 |
